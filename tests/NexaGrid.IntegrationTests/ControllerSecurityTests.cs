...
namespace NexaGrid.IntegrationTests;
...
public sealed class ControllerSecurityTests
{
    ...
    public async Task RevokedEnrollmentCodeCannotBeUsed()
    {
        ...
        revoke.Headers.Add("X-NexaGrid-Request", "ui");
    ...
    public async Task LocalInstallerBootstrapCodeIsImportedOnce()
    {
        ...
        var codePath = Path.Combine(factory.DataDirectory, NexaGrid.Controller.Services.CombinedRoleBootstrap.BootstrapFileName);
    ...
    internal static async Task<EnrollmentTokenResponse> CreateTokenAsync(HttpClient client)
    {
        ...
        request.Headers.Add("X-NexaGrid-Request", "ui");
    ...
    internal static HardwareInventory Inventory() => new("Windows Test", "10.0", "X64", 8, 16_000, [], "0.1.0", true);
